...
```
sudo kubeadm init --pod-network-cidr=10.244.0.0/16 --apiserver-advertise-address=192.168.56.2 --node-name master-node
```
>Note: Copy the copy to the notepad that was generated after the init command completion, we will use that later.

**
sudo kubeadm join 192.168.56.2:6443 --token hahisi.b1mi8olubsw7w6o6 \
        --discovery-token-ca-cert-hash sha256:6d93f7d7d43aff5d3a244a69d784c0176a6bc8361585c6be18d6d9ebc1640bfd
**
