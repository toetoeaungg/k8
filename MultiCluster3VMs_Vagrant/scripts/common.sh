...
# Use sed to find and replace 'SystemdCgroup = false' with 'SystemdCgroup = true'
sudo sed -i 's/SystemdCgroup = false/SystemdCgroup = true/' "$file"
# Check if the replacement was successful
if grep -q 'SystemdCgroup = true' "$file"; then
